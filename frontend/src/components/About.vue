  ...
  <div>
    ...
    <div class="container px-4 px-lg-5">
      ...
      <div class="card my-5 text-dark py-4 text-center">
        <div class="card-body">
          <p class="text-dark m-0 font-weight-bold" style="font-size: 2.5rem">
            Rólunk
          </p>
        </div>
      </div>
          ...
          <div class="card h-100">
            <div class="card-body">
              <div class="bg-white py-5 px-4">
                <img
                  src="@/assets/images/bence.jpg"
                  alt=""
                  width="60%"
                  class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                />
                <h5 class="mb-0">Kovács Bence Dominik</h5>
                <span class="small text-uppercase text-muted">Tanuló</span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-6 mb-5">
          <div class="card h-100">
            <div class="card-body">
              <div class="bg-white py-5 px-4">
                <img
                  src="@/assets/images/tomi.jpg"
                  alt=""
                  width="60%"
                  class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
                />
                <h5 class="mb-0">Szabó Tamás Martin</h5>
                <span class="small text-uppercase text-muted">Tanuló</span>
              </div>
            </div>
          </div>
